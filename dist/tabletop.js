...
(function() {
  ...
  var request = function requestNotProvided() {
    throw new Error(
      "The 'request' module is only available while running in Node."
    );
  };
  if (inNodeJS) {
  ...
  */
  ...
  var Tabletop = function(options) {
    ...
    this.prettyColumnNames =
      typeof options.prettyColumnNames === "undefined"
        ? !options.proxy
        : options.prettyColumnNames;
    ...
    this.baseJsonPath =
      "/feeds/worksheets/" + this.key + "/" + this.sheetPrivacy + "/basic?alt=";
